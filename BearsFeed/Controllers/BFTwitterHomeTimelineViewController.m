//
//  BFTwitterHomeTimelineViewController.m
//  BearsFeed
//
...
@interface BFTwitterHomeTimelineViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    NSString* _maxID;
    int _loadCount;
    BOOL tempIsOn;
...
@implementation BFTwitterHomeTimelineViewController
...
- (void)initLoadUserFeedData {
    
    self.statusesArray = [[NSMutableArray alloc] init];
    
    [[GlobalData sharedGlobalData].twitter getHomeTimelineSinceID:nil count:_loadCount successBlock:^(NSArray *statuses) {
...
- (void)finishLoadMore {
    ...
    [[GlobalData sharedGlobalData].twitter getStatusesHomeTimelineWithCount:[NSString stringWithFormat:@"%i", _loadCount] sinceID:nil maxID:_maxID trimUser:nil excludeReplies:nil contributorDetails:nil includeEntities:nil successBlock:^(NSArray *statuses) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([feedData.type isEqualToString:POST_TYPE_PHOTO]) {
        ...
        [cell.btnPhoto addTarget:self action:@selector(onDetailTwitterHomePhotoView:) forControlEvents:UIControlEventTouchUpInside];
        [cell.btnPost addTarget:self action:@selector(onTwitterHomeFeedPost:) forControlEvents:UIControlEventTouchUpInside];
        [cell.btnEdit addTarget:self action:@selector(onTwitterHomeFeedEdit:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)onDetailTwitterHomePhotoView:(id)sender {
...
-(void)onTwitterHomeFeedPost:(id)sender {
...
-(void)onTwitterHomeFeedEdit:(id)sender {
