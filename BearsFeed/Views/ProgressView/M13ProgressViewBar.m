...
- (void)setup
{
    ...
    //Set default colors
    self.primaryColor = [UIColor colorWithRed:228/255.0 green:58/255.0 blue:32/255.0 alpha:1.0];
    self.secondaryColor = [UIColor colorWithRed:96/255.0 green:99/255.0 blue:104/255.0 alpha:1.0];
    ...
    _percentageLabel.foregroundColor = [UIColor whiteColor].CGColor;
