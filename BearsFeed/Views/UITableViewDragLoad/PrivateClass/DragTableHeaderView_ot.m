...
//		[self addSubview:_statusLabel];
		...
		_arrowImage.frame = CGRectMake(25.0f, frame.size.height - 45.0f, 12.0f, 30.0f);
...
//    _arrowImage.frame = CGRectMake(25.0f, frame.size.height - 45.0f, 12.0f, 30.0f);
    _activityView.frame = CGRectMake(0.0f, frame.size.height - 38.0f, self.frame.size.width, 20.0f);
}
