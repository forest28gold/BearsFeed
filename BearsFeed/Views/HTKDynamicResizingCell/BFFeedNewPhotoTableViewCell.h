 ...
 */
#define DEFAULT_CELL_SIZE_FEED (CGSize){[[UIScreen mainScreen] bounds].size.width, 375}

/**
 * Sample CollectionViewCell that implements the dynamic sizing protocol.
 */
@interface BFFeedNewPhotoTableViewCell : HTKDynamicResizingTableViewCell
