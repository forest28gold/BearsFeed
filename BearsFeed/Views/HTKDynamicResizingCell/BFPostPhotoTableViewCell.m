...
@interface BFPostPhotoTableViewCell () <TTTAttributedLabelDelegate>

@end

@implementation BFPostPhotoTableViewCell
...
- (void)setupView {
    ...
    // Constrain
    NSDictionary *viewDict = NSDictionaryOfVariableBindings(_imgAvatar, _lblName, _lblPost, _btnReadMore, _btnUpVote, _lblVoteCount, _btnDownVote, _imgPost, _btnPhoto, _btnShareFB, _btnShareTW, _btnShareINS, _lblShareCount, _viewLineShare, _btnComment, _imgTime, _lblTimeStamp, _viewLine, _btnReply, _viewSeperate);
    
    // Create a dictionary with buffer values
    NSDictionary *metricDict = @{@"sideBuffer" : @18, @"avatarSize" : @40, @"sidePostBuffer" : @20, @"buttonVoteSize" : @30, @"buttonShareSize" : @30, @"buttonReadMoreSize" : @80, @"sideImageBuffer" : @35, @"imgPostSize" : @250, @"buttonCommentSize" : @120, @"sideTimeBuffer" : @95, @"sideTimeEndBuffer" : @15, @"imgTimeSize" : @20, @"verticalBuffer" : @15, @"verticalNameBuffer" : @25, @"verticalPostBuffer" : @8, @"imgPostHeight" : @180, @"verticalCommentBuffer" : @15, @"verticalVoteBuffer" : @35, @"verticalLineBuffer" : @10, @"commentHeight" : @20, @"lineHeight" : @1, @"replyHeight" : @36, @"seperateHeight" : @5};
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalPostBuffer-[_btnReadMore(buttonVoteSize)]-verticalPostBuffer-[_btnPhoto(imgPostHeight)]-verticalCommentBuffer-[_btnShareFB(buttonShareSize)]-verticalLineBuffer-[_viewLineShare(lineHeight)]-verticalCommentBuffer-[_btnComment(commentHeight)]-verticalLineBuffer-[_viewLine(lineHeight)]-[_btnReply(replyHeight)]-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
...
//    NSLog(@"No of lines: %ld",(long)numberOfLines);
    ...
    NSString *strUrl = postData.filePath;    
