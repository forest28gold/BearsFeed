...
@interface BFFeedTableViewCell () <TTTAttributedLabelDelegate>
...
- (void)setupView {
    ...
    // Constrain
    NSDictionary *viewDict = NSDictionaryOfVariableBindings(_imgAvatar, _lblName, _lblPost, _viewLine, _btnPost, _btnEdit, _viewSeperate);
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_viewLine(lineHeight)]-[_btnPost(replyHeight)]-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
    
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_viewLine(lineHeight)]-[_btnEdit(replyHeight)]-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
