...
@interface BFFeedNewTableViewCell () <TTTAttributedLabelDelegate>

@end

@implementation BFFeedNewTableViewCell
...
- (void)setupView {
    ...
    self.lblName.font = [UIFont fontWithName:@"HelveticaNeue" size:13];
    ...
    // Constrain
    NSDictionary *viewDict = NSDictionaryOfVariableBindings(_imgAvatar, _lblName, _lblPost, _btnShareFB, _btnShareTW, _btnShareINS, _lblShareCount, _viewSeperate);
    
    // Create a dictionary with buffer values
    NSDictionary *metricDict = @{@"sideBuffer" : @18, @"avatarSize" : @40, @"sidePostBuffer" : @20, @"buttonVoteSize" : @30, @"buttonShareSize" : @30, @"buttonReadMoreSize" : @80, @"sideImageBuffer" : @35, @"imgPostSize" : @250, @"buttonRepost" : @160, @"sideTimeBuffer" : @95, @"sideTimeEndBuffer" : @15, @"imgTimeSize" : @20, @"verticalBuffer" : @15, @"verticalNameBuffer" : @25, @"verticalPostBuffer" : @8, @"imgPostHeight" : @1, @"verticalCommentBuffer" : @15, @"verticalVoteBuffer" : @35, @"verticalLineBuffer" : @10, @"commentHeight" : @20, @"lineHeight" : @1, @"replyHeight" : @36, @"seperateHeight" : @5};
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_btnShareFB(buttonShareSize)]-verticalLineBuffer-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
    
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_btnShareTW(buttonShareSize)]-verticalLineBuffer-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
    
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_btnShareINS(buttonShareSize)]-verticalLineBuffer-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
    
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-verticalBuffer-[_imgAvatar(avatarSize)]-verticalPostBuffer-[_lblPost]-verticalLineBuffer-[_lblShareCount(buttonShareSize)]-verticalLineBuffer-[_viewSeperate(seperateHeight)]|" options:0 metrics:metricDict views:viewDict]];
    ...
    CGSize defaultSize = DEFAULT_CELL_SIZES_FEED;
